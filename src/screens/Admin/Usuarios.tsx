...
const Usuarios: React.FC = () => {
  ...
  const usuariosFiltrados = useMemo(() => { setPagina(1); return usuarios.filter(u => {
  ...
  const usuariosPagina = useMemo(() => usuariosFiltrados.slice((pagina-1)*POR_PAGINA, pagina*POR_PAGINA), [usuariosFiltrados, pagina]);
      ...
      <div className="usuarios-main">
        ...
        <div className="usuarios-content">
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", marginBottom: 16 }}>
            ...
            <button
              onClick={() => exportUsuariosPDF(usuariosFiltrados, ROL_ACTUAL)}
              title="Descargar PDF"
              style={{
